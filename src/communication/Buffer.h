...
public:
  ...
  void retrieveInt64() { retrieve(sizeof(long long)); }

  void retrieveInt32() { retrieve(sizeof(int)); }

  void retrieveInt16() { retrieve(sizeof(short)); }

  void retrieveInt8() { retrieve(sizeof(char)); }
  ...
  void appendInt8(char x) { append(&x, sizeof(x)); }
  ...
  void prependInt8(char x) { prepend(&x, sizeof(x)); }
