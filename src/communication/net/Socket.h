...
public:
    ...
    ///
    ssize_t sendto(const void* buf, size_t len, const char* path, int sendto_flags = 0);
    ssize_t sendto(const void* buf, size_t len, const std::string& path, int sendto_flags = 0);
    ssize_t sendto(const std::string& buf, const std::string& path, int sendto_flags = 0);

    ssize_t recvfrom(void* buf, size_t len, char* source, size_t source_len, int recvfrom_flags = 0);
    ssize_t recvfrom(void* buf, size_t len, std::string& source, int recvfrom_flags = 0);
    ssize_t recvfrom(std::string& buf, std::string& source, int recvfrom_flags = 0);
    ...
    ssize_t sendto(const std::string& buf, const InetAddress& dst, int sndto_flags = 0);

    ssize_t recvfrom(void* buf, size_t len, InetAddress& src, int rcvfrom_flags = 0);
