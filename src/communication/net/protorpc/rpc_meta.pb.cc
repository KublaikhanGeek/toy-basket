...
RpcMeta::RpcMeta(const RpcMeta& from)
  ...
  ::memcpy(&id_, &from.id_,
    ...
    reinterpret_cast<char*>(&id_)) + sizeof(data_size_));
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcMeta::_InternalSerialize(
  ...
  if (this->data_size() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->_internal_data_size(), target);
  }
...
void RpcMeta::InternalSwap(RpcMeta* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RpcMeta, data_size_)
      + sizeof(RpcMeta::data_size_)
...
template<> PROTOBUF_NOINLINE ::toyBasket::RpcMeta* Arena::CreateMaybeMessage< ::toyBasket::RpcMeta >(Arena* arena) {
